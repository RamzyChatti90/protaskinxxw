...
type RestOf<T extends ITeam | NewTeam> = Omit<T, 'startDate' | 'createdAt'> & {
...
export class TeamService {
  ...
  protected convertDateFromClient<T extends ITeam | NewTeam | PartialUpdateTeam>(team: T): RestOf<T> {
    return {
      ...team,
      startDate: team.startDate?.format(DATE_FORMAT) ?? null,
  ...
  protected convertDateFromServer(restTeam: RestTeam): ITeam {
    return {
      ...restTeam,
      startDate: restTeam.startDate ? dayjs(restTeam.startDate) : undefined,
