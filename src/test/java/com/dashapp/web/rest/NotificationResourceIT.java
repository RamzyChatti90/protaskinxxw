package com.dashapp.web.rest;

import static com.dashapp.domain.NotificationAsserts.*;
import static com.dashapp.web.rest.TestUtil.createUpdateProxyForBean;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.dashapp.IntegrationTest;
import com.dashapp.domain.Notification;
import com.dashapp.domain.enumeration.Type;
import com.dashapp.repository.NotificationRepository;
import com.dashapp.service.dto.NotificationDTO;
import com.dashapp.service.mapper.NotificationMapper;
...
class NotificationResourceIT {
    ...
    public static Notification createEntity() {
        return new Notification().title(DEFAULT_TITLE).message(DEFAULT_MESSAGE).sentAt(DEFAULT_SENT_AT).type(DEFAULT_TYPE);
    }
    ...
    public static Notification createUpdatedEntity() {
        return new Notification().title(UPDATED_TITLE).message(UPDATED_MESSAGE).sentAt(UPDATED_SENT_AT).type(UPDATED_TYPE);
    }
    ...
    void putExistingNotification() throws Exception {
        ...
        updatedNotification.title(UPDATED_TITLE).message(UPDATED_MESSAGE).sentAt(UPDATED_SENT_AT).type(UPDATED_TYPE);
    ...
    void fullUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.title(UPDATED_TITLE).message(UPDATED_MESSAGE).sentAt(UPDATED_SENT_AT).type(UPDATED_TYPE);
