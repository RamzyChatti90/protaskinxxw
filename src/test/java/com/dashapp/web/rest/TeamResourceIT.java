...
import static com.dashapp.domain.TeamAsserts.*;
...
class TeamResourceIT {
    ...
    public static Team createEntity() {
        return new Team().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).startDate(DEFAULT_START_DATE).createdAt(DEFAULT_CREATED_AT);
    }
    ...
    public static Team createUpdatedEntity() {
        return new Team().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).startDate(UPDATED_START_DATE).createdAt(UPDATED_CREATED_AT);
    }
    ...
    void putExistingTeam() throws Exception {
        ...
        updatedTeam.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).startDate(UPDATED_START_DATE).createdAt(UPDATED_CREATED_AT);
    ...
    void fullUpdateTeamWithPatch() throws Exception {
        ...
        partialUpdatedTeam.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).startDate(UPDATED_START_DATE).createdAt(UPDATED_CREATED_AT);
